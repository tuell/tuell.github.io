...
var startTurnButton = document.getElementById("startZug");
...
function updateButtons(state) {
  ...
  switch(state) {
    ...
    case 2.5:
      ...
      infoLine.innerHTML = "<h6 class='mb-1'><i class='em em-question mr-1'></i> " + turnWaitMsg +  "</h6>";
      break;
    case 3:
 ...
 // Let player choose category
  ...
  $(document).on('click', '.category_link', function(event) {
    ...
    if (stateOfGame == 2.5) {
      ...
      newSummaryPlayer.classList.add("p-1", "col-6", "col-sm-5");
      newSummaryPlayer.innerHTML = "Player: " + currentPlayerCard[0] + "<br>" + data_header[categoryID] + " &ndash; " + currentPlayerCard[categoryID] + data_suffix[categoryID];

      var newSummaryComputer = document.createElement("div");
      newSummaryComputer.classList.add("p-1", "col-6", "col-sm-5");
      ...
      if (data_comparison[categoryID] == "larger") {
        if (firstPlayerCard[categoryID] > firstComputerCard[categoryID]) {
          ...
          infoLine.innerHTML = "<h6 class='mb-1'><i class='em em-grinning mr-1'></i> " + turnWonMsg +  "</h6>";
          ...
          infoLine.innerHTML = "<h6 class='mb-1'><i class='em em-disappointed mr-1'></i> " + turnLostMsg +  "</h6>";
          ...
          infoLine.innerHTML = "<h6 class='mb-1'><i class='em em-full_moon_with_face mr-1'></i> " + turnDrawMsg +  "</h6>";
        ...
        if (firstPlayerCard[categoryID] < firstComputerCard[categoryID]) {
          ...
          infoLine.classList.remove('text-secondary');
          infoLine.classList.add('text-success');
          infoLine.innerHTML = "<h6 class='mb-1'><i class='em em-grinning mr-2'></i> " + turnWonMsg +  "</h6>";
          playerPoints += 1;
          gameProgressBar.appendChild(progressBarWin);
        } else if (firstPlayerCard[categoryID] > firstComputerCard[categoryID]) {
          chosenPlayerCategory.classList.add('list-group-item-danger');
      ...
      if (playerCards.length > 0) {
        ...
        infoLine.classList.remove('text-danger');
        infoLine.classList.add('text-secondary');
        infoLine.innerHTML = "<h6 class='mb-1'><i class='em em-checkered_flag mr-1'></i> " + gameOverMsg + "</h6>";
      }
