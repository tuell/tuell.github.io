...
var data_header = ['Wahlkreis', 'Fläche', 'Bevölkerung', 'Kirchensteuerzahler', 'Zuzugsbilanz', 'Schweine', 'Waldfläche'];
var data_suffix = ['', '', '', ' %', '', '', ' %'];
...
var darmstadt-dieburg_i = ['Darmstadt-Dieburg I', 173.74, 120744, 59, 802, 5051, 28];
var darmstadt-dieburg_ii = ['Darmstadt-Dieburg II', 365.28, 127450, 67, 904, 16156, 37];
var darmstadt-stadt_i_und_ii = ['Darmstadt-Stadt I und II', 241.7, 203987, 55, 2368, 470, 40];
var eschwege-witzenhausen = ['Eschwege-Witzenhausen', 595.18, 75970, 77, 868, 6048, 42];
var frankfurt_am_main_i_-_vi = ['Frankfurt am Main I - VI', 248.31, 736414, 44, 480, 1123, 15];
...
var groß-gerau_i = ['Groß-Gerau I', 123, 136188, 47, 1759, 0, 26];
var groß-gerau_ii = ['Groß-Gerau II', 330.03, 132857, 56, 1008, 5452, 19];
...
var kassel-land_i = ['Kassel-Land I', 1020.22, 114530, 77, 868, 44014, 27];
var kassel-land_ii = ['Kassel-Land II', 268.49, 120433, 70, 1295, 7202, 27];
var kassel-stadt_i_und_ii = ['Kassel-Stadt I und II', 106.78, 199062, 57, 1210, 0, 21];
var lahn-dill_i = ['Lahn-Dill I', 648.09, 122713, 69, 322, 93, 51];
var lahn-dill_ii = ['Lahn-Dill II', 418.44, 131361, 70, 1359, 1739, 42];
var limburg-weilburg_i = ['Limburg-Weilburg I', 264.68, 88262, 75, 674, 6188, 22];
var limburg-weilburg_ii = ['Limburg-Weilburg II', 473.78, 83858, 76, 16, 7835, 40];
var main-kinzig_i = ['Main-Kinzig I', 305.84, 127743, 66, 955, 1857, 27];
var main-kinzig_ii = ['Main-Kinzig II', 141.46, 159720, 52, 3343, 7, 18];
var main-kinzig_iii = ['Main-Kinzig III', 950.25, 129252, 75, 982, 2905, 50];
var main-taunus_i = ['Main-Taunus I', 100.06, 119224, 57, 1305, 0, 18];
var main-taunus_ii = ['Main-Taunus II', 122.33, 116484, 60, 1446, 304, 9];
var marburg-biedenkopf_i = ['Marburg-Biedenkopf I', 770.59, 111323, 75, 175, 13033, 40];
var marburg-biedenkopf_ii = ['Marburg-Biedenkopf II', 491.95, 133690, 70, 153, 14820, 37];
...
var offenbach-stadt_ = ['Offenbach-Stadt ', 44.89, 124589, 44, 463, 0, 33];
var rheingau-taunus_i = ['Rheingau-Taunus I', 444.47, 89137, 68, 727, 0, 54];
var rheingau-taunus_ii = ['Rheingau-Taunus II', 367.01, 96531, 61, 1305, 939, 49];
var rotenburg = ['Rotenburg', 940.89, 77211, 79, 495, 43362, 44];
var schwalm-eder_i = ['Schwalm-Eder I', 613.33, 90371, 77, 1015, 77482, 31];
var schwalm-eder_ii = ['Schwalm-Eder II', 925.16, 90734, 83, 659, 70573, 36];
var vogelsberg = ['Vogelsberg', 1556.01, 116432, 83, 140, 61134, 39];
var waldeck-frankenberg_i = ['Waldeck-Frankenberg I', 907.62, 79754, 78, 634, 44329, 38];
var waldeck-frankenberg_ii = ['Waldeck-Frankenberg II', 940.82, 78213, 80, 442, 17993, 53];
